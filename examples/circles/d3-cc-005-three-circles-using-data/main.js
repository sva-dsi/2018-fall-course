...
function make(){
  ...
  circleData.push({x:width*0.25, y:height/2, radius:50, color:"#E8FDF5"})
  circleData.push({x:width*0.5, y:height/2, radius:50, color:"#FFDFDF"})
  circleData.push({x:width*0.75, y:height/2, radius:50, color:"#FFFCEB"})
